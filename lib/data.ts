...
export const categories: Category[] = [
  {
    id: 'grocery',
    name: 'Grocery & Specialty Food',
    description: 'Pantry staples, specialty foods, and everyday grocery items',
  ...
  },
  {
    ...
    description: 'Cleaning products and everyday household essentials',
  ...
  },
  {
    id: 'home',
    name: 'Home Goods',
    description: 'Kitchenware, home essentials, and consumer products',
...
export const products: Product[] = [
  ...
  },
  {
    ...
    images: ['/images/product-2.png', '/images/category-grocery.png'],
  ...
  },
  {
    ...
    description:
      'An effective multi-surface cleaning solution packaged in convenient spray bottles and shipped by the case. A reliable high-turn household essential for grocery, hardware, and general retail. Consistent supply backed by trusted distributor relationships.',
    specifications: [
  ...
  },
  {
    ...
    images: ['/images/product-5.png', '/images/category-household.png'],
...
export const segments = [
  { id: 1, name: 'Grocery' },
  { id: 2, name: 'Specialty Food' },
  { id: 3, name: 'Health & Wellness' },
  { id: 4, name: 'Household Essentials' },
  { id: 5, name: 'Cleaning Products' },
  { id: 6, name: 'Home Goods' },
  { id: 7, name: 'Consumer Products' },
